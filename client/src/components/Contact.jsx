...
<FormControl className="mb-1">
  ...
  <Input className="w-full" type="tel" placeholder="Enter your phone number" />
</FormControl>
  ...
  <Button
    ...
    width="full"
    md={4}
    className="bg-formColor  hover:bg-teal-700 hover:text-white text-customBlack border-transparent rounded-sm font-semibold py-2 px-4 w-full h-3/5 mt-10"
  >
    Submit
</Button>
      </Box>
