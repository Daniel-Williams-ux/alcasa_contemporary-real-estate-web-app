    ...
    <div>
      ...
      <div className="bg-gray-100 py-16">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="flex justify-center mb-8">
            <img src="/dawn-ground.jpg" alt="Luxury Properties" className="w-full md:max-w-sm rounded-lg shadow-lg" />
          </div>
      ...
      <div className="bg-gray-100 py-16">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="flex justify-center mb-8">
            <img src="/dawn-first.jpg" alt="Luxury Properties" className="w-full md:max-w-sm rounded-lg shadow-lg" />
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {/* first floor details */}
            <div>
      ...
      <div className="bg-gray-100 py-16">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="flex justify-center mb-8">
            <img src="/dawn-base.jpg" alt="Luxury Properties" className="w-full md:max-w-sm rounded-lg shadow-lg" />
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {/* Ground floor details */}
            <div>
